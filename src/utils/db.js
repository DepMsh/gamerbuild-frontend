...
export const COMPONENTS = {
  ...
  cpu: [
    ...
    { id: 'cpu-9', name: 'AMD Ryzen 5 7600X', brand: 'AMD', price: 699, asin: 'B0BBJMS1TN', score: 72, socket: 'AM5', cores: 6, threads: 12, baseClock: 4.7, boostClock: 5.3, tdp: 105, tier: 'mid-range' },
    { id: 'cpu-12', name: 'AMD Ryzen 9 7950X', brand: 'AMD', price: 1899, asin: 'B0BBHHT8LY', score: 88, socket: 'AM5', cores: 16, threads: 32, baseClock: 4.5, boostClock: 5.7, tdp: 170, tier: 'enthusiast' },
    // Intel 14th/13th Gen (LGA1700)
    { id: 'cpu-10', name: 'Intel Core i7-14700K', brand: 'Intel', price: 1449, asin: 'B0CGJ41C9W', score: 80, socket: 'LGA1700', cores: 20, threads: 28, baseClock: 3.4, boostClock: 5.6, tdp: 125, tier: 'high-end' },
    { id: 'cpu-11', name: 'Intel Core i5-14600K', brand: 'Intel', price: 999, asin: 'B0CGJ9STNF', score: 73, socket: 'LGA1700', cores: 14, threads: 20, baseClock: 3.5, boostClock: 5.3, tdp: 125, tier: 'mid-range' },
    { id: 'cpu-13', name: 'Intel Core i9-14900K', brand: 'Intel', price: 2249, asin: 'B0CGJDKLB8', score: 83, socket: 'LGA1700', cores: 24, threads: 32, baseClock: 3.2, boostClock: 6.0, tdp: 253, tier: 'enthusiast' },
    { id: 'cpu-15', name: 'Intel Core i3-14100F', brand: 'Intel', price: 349, asin: 'B0CQ1MN1Y2', score: 42, socket: 'LGA1700', cores: 4, threads: 8, baseClock: 3.5, boostClock: 4.7, tdp: 58, tier: 'budget' },
    { id: 'cpu-17', name: 'Intel Core i5-13600K', brand: 'Intel', price: 899, asin: 'B0BCDR9M33', score: 65, socket: 'LGA1700', cores: 14, threads: 20, baseClock: 3.5, boostClock: 5.1, tdp: 125, tier: 'mid-range' },
    // AMD Ryzen 5000 (AM4)
    { id: 'cpu-14', name: 'AMD Ryzen 5 5600X', brand: 'AMD', price: 449, asin: 'B08166SLDF', score: 55, socket: 'AM4', cores: 6, threads: 12, baseClock: 3.7, boostClock: 4.6, tdp: 65, tier: 'budget' },
    { id: 'cpu-16', name: 'AMD Ryzen 7 5800X3D', brand: 'AMD', price: 849, asin: 'B09VCJ2GHJ', score: 70, socket: 'AM4', cores: 8, threads: 16, baseClock: 3.4, boostClock: 4.5, tdp: 105, tier: 'mid-range' },
  ],
  ...
  gpu: [
    ...
    { id: 'gpu-11', name: 'NVIDIA RTX 4070 Ti Super', brand: 'NVIDIA', price: 2899, asin: 'B0CSGCTMT2', search: 'MSI+RTX+4070+Ti+Super+16G+Gaming+X+Slim', score: 66, vram: 16, tdp: 285, tier: 'high-end' },
    { id: 'gpu-12', name: 'NVIDIA RTX 4070 Super', brand: 'NVIDIA', price: 2399, asin: 'B0CT8LQZ47', search: 'Nvidia+GeForce+RTX+4070+Super+Founders+Edition+12GB', score: 60, vram: 12, tdp: 220, tier: 'mid-range' },
    { id: 'gpu-13', name: 'NVIDIA RTX 4060 Ti', brand: 'NVIDIA', price: 1599, asin: 'B0C5B4XNWR', search: 'MSI+GeForce+RTX+4060+Ti+Ventus+2X+Black+8G+OC', score: 48, vram: 8, tdp: 160, tier: 'mid-range' },
    { id: 'gpu-14', name: 'NVIDIA RTX 4060', brand: 'NVIDIA', price: 1199, asin: 'B0C8BPW1SP', search: 'MSI+GeForce+RTX+4060+Ventus+2X+Black+8G+OC', score: 40, vram: 8, tdp: 115, tier: 'budget' },
    // AMD RX 7000 Series (RDNA 3)
    { id: 'gpu-15', name: 'AMD RX 7900 XTX', brand: 'AMD', price: 3499, asin: 'B0BMWG9N16', search: 'PowerColor+AMD+Radeon+RX+7900+XTX+24GB', score: 70, vram: 24, tdp: 355, tier: 'high-end' },
    { id: 'gpu-16', name: 'AMD RX 7800 XT', brand: 'AMD', price: 1799, asin: 'B0CGRMJF6C', search: 'Gigabyte+Radeon+RX+7800+XT+Gaming+OC+16G', score: 55, vram: 16, tdp: 263, tier: 'mid-range' },
  ...
  motherboard: [
    ...
    { id: 'mb-2', name: 'MSI MAG X870 Tomahawk WiFi', brand: 'MSI', price: 1199, asin: 'B0DCVVXK8D', search: 'MSI+MAG+X870+Tomahawk+WiFi+DDR5+AM5', socket: 'AM5', chipset: 'X870', formFactor: 'ATX', ramType: 'DDR5', ramSlots: 4, maxRam: 256, m2Slots: 4, wifi: true, tier: 'high-end' },
    { id: 'mb-3', name: 'Gigabyte B850 AORUS Elite WiFi7', brand: 'Gigabyte', price: 923, asin: 'B0DQLKRXKW', search: 'Gigabyte+B850+AORUS+Elite+WiFi7+ICE+AM5', socket: 'AM5', chipset: 'B850', formFactor: 'ATX', ramType: 'DDR5', ramSlots: 4, maxRam: 256, m2Slots: 3, wifi: true, tier: 'mid-range' },
    { id: 'mb-4', name: 'MSI MAG B650 Tomahawk WiFi', brand: 'MSI', price: 749, asin: 'B0BHCCNSRH', search: 'MSI+MAG+B650+Tomahawk+WiFi+DDR5+AM5', socket: 'AM5', chipset: 'B650', formFactor: 'ATX', ramType: 'DDR5', ramSlots: 4, maxRam: 128, m2Slots: 2, wifi: true, tier: 'mid-range' },
    { id: 'mb-11', name: 'ASUS ROG Strix X670E-E WiFi', brand: 'ASUS', price: 1799, asin: 'B0BDTHQTJV', search: 'ASUS+ROG+Strix+X670E-E+Gaming+WiFi+AM5', socket: 'AM5', chipset: 'X670E', formFactor: 'ATX', ramType: 'DDR5', ramSlots: 4, maxRam: 128, m2Slots: 4, wifi: true, tier: 'high-end' },
    ...
    { id: 'mb-14', name: 'MSI MAG B860 Tomahawk WiFi', brand: 'MSI', price: 849, asin: 'B0DQBJ64KH', search: 'MSI+MAG+B860+Tomahawk+WiFi+DDR5+LGA1851', socket: 'LGA1851', chipset: 'B860', formFactor: 'ATX', ramType: 'DDR5', ramSlots: 4, maxRam: 256, m2Slots: 3, wifi: true, tier: 'mid-range' },
    // LGA1700 — Z790 / B760 (Intel 13th/14th Gen)
    { id: 'mb-8', name: 'ASUS ROG Maximus Z790 Hero', brand: 'ASUS', price: 2299, asin: 'B0BG6M53DG', search: 'ASUS+ROG+Maximus+Z790+Hero+WiFi+6E+DDR5', socket: 'LGA1700', chipset: 'Z790', formFactor: 'ATX', ramType: 'DDR5', ramSlots: 4, maxRam: 128, m2Slots: 5, wifi: true, tier: 'enthusiast' },
    { id: 'mb-9', name: 'MSI MAG Z790 Tomahawk WiFi', brand: 'MSI', price: 1199, asin: 'B0BL8K1YH1', search: 'MSI+MAG+Z790+Tomahawk+WiFi+DDR5+LGA1700', socket: 'LGA1700', chipset: 'Z790', formFactor: 'ATX', ramType: 'DDR5', ramSlots: 4, maxRam: 128, m2Slots: 4, wifi: true, tier: 'high-end' },
    { id: 'mb-10', name: 'MSI PRO B760M-A WiFi', brand: 'MSI', price: 399, asin: 'B0C15VWF1H', search: 'MSI+PRO+B760M-A+WiFi+DDR5+LGA1700', socket: 'LGA1700', chipset: 'B760', formFactor: 'mATX', ramType: 'DDR5', ramSlots: 2, maxRam: 64, m2Slots: 2, wifi: false, tier: 'budget' },
    // AM4 — B550
  ...
  ram: [
    ...
    { id: 'ram-10', name: 'Kingston Fury Renegade DDR5-8000 32GB', brand: 'Kingston', price: 1199, asin: 'B0CKZ9SGFY', search: 'Kingston+Fury+Renegade+DDR5+8000+32GB+RGB', type: 'DDR5', size: 32, speed: 8000, latency: 'CL38', modules: '2x16GB', tier: 'enthusiast' },
    { id: 'ram-2', name: 'G.Skill Trident Z5 Neo DDR5-7200 32GB', brand: 'G.Skill', price: 662, asin: 'B0DD243MYB', search: 'G.Skill+Trident+Z5+Neo+RGB+DDR5+7200+CL34+32GB', type: 'DDR5', size: 32, speed: 7200, latency: 'CL34', modules: '2x16GB', tier: 'high-end' },
    { id: 'ram-3', name: 'Corsair Dominator Titanium DDR5-7200 32GB', brand: 'Corsair', price: 849, asin: 'B0CHSBX471', search: 'Corsair+Dominator+Titanium+DDR5+7200+CL34+32GB', type: 'DDR5', size: 32, speed: 7200, latency: 'CL34', modules: '2x16GB', tier: 'high-end' },
    // DDR5 Mid Speed
    { id: 'ram-4', name: 'G.Skill Trident Z5 RGB DDR5-6000 32GB', brand: 'G.Skill', price: 499, asin: 'B0BFCV7JZ8', search: 'G.Skill+Trident+Z5+NEO+32GB+DDR5+6000MHz+CL30+2x16GB', type: 'DDR5', size: 32, speed: 6000, latency: 'CL30', modules: '2x16GB', tier: 'mid-range' },
    { id: 'ram-5', name: 'Corsair Vengeance DDR5-5600 32GB', brand: 'Corsair', price: 399, asin: 'B09WH64X5M', search: 'Corsair+Vengeance+DDR5+32GB+5600MHz+CL36+2x16GB', type: 'DDR5', size: 32, speed: 5600, latency: 'CL36', modules: '2x16GB', tier: 'mid-range' },
    { id: 'ram-6', name: 'Kingston Fury Beast DDR5-5200 16GB', brand: 'Kingston', price: 199, asin: 'B09T97ZSVB', search: 'Kingston+Fury+Beast+16GB+5200MT+DDR5+CL40+2x8GB', type: 'DDR5', size: 16, speed: 5200, latency: 'CL40', modules: '2x8GB', tier: 'budget' },
    { id: 'ram-7', name: 'G.Skill Trident Z5 RGB DDR5-6400 64GB', brand: 'G.Skill', price: 899, asin: 'B0BJ7X9P1W', search: 'G.Skill+Trident+Z5+RGB+64GB+DDR5+6400+CL32+2x32GB', type: 'DDR5', size: 64, speed: 6400, latency: 'CL32', modules: '2x32GB', tier: 'enthusiast' },
    // DDR4
  ...
  ssd: [
    ...
    { id: 'ssd-2', name: 'Crucial T705 2TB', brand: 'Crucial', price: 1299, asin: 'B0CTRVZKG7', search: 'Crucial+T705+2TB+Gen5+NVMe+M.2+SSD', interface: 'NVMe Gen5', capacity: 2000, read: 14500, write: 12700, tier: 'enthusiast' },
    { id: 'ssd-9', name: 'Crucial T700 2TB', brand: 'Crucial', price: 999, asin: 'B0C3K7MTSY', search: 'Crucial+T700+2TB+Gen5+NVMe+M.2+SSD', interface: 'NVMe Gen5', capacity: 2000, read: 12400, write: 11800, tier: 'enthusiast' },
    // Gen4 NVMe
    { id: 'ssd-3', name: 'Samsung 990 EVO Plus 2TB', brand: 'Samsung', price: 549, asin: 'B0DHLCRF91', search: 'Samsung+990+EVO+Plus+2TB+PCIe+Gen4+NVMe', interface: 'NVMe Gen4', capacity: 2000, read: 7250, write: 6300, tier: 'high-end' },
    { id: 'ssd-4', name: 'Samsung 990 Pro 1TB', brand: 'Samsung', price: 449, asin: 'B0BHJF2VRN', search: 'Samsung+990+PRO+1TB+PCIe+Gen4+NVMe+M.2', interface: 'NVMe Gen4', capacity: 1000, read: 7450, write: 6900, tier: 'high-end' },
    { id: 'ssd-5', name: 'Samsung 990 Pro 2TB', brand: 'Samsung', price: 749, asin: 'B0BHJJ9Y77', search: 'Samsung+990+PRO+2TB+PCIe+Gen4+NVMe+M.2', interface: 'NVMe Gen4', capacity: 2000, read: 7450, write: 6900, tier: 'high-end' },
    { id: 'ssd-6', name: 'WD Black SN850X 1TB', brand: 'WD', price: 349, asin: 'B0B7CKVCCV', search: 'WD_BLACK+SN850X+1TB+NVMe+Gen4+SSD', interface: 'NVMe Gen4', capacity: 1000, read: 7300, write: 6300, tier: 'mid-range' },
    { id: 'ssd-10', name: 'Samsung 990 EVO Plus 4TB', brand: 'Samsung', price: 1118, asin: 'B0DHLBDSP7', search: 'Samsung+990+EVO+Plus+4TB+NVMe', interface: 'NVMe Gen4', capacity: 4000, read: 7250, write: 6300, tier: 'enthusiast' },
    // Budget
  ...
  psu: [
    ...
    { id: 'psu-2', name: 'Corsair RM1200x Shift', brand: 'Corsair', price: 990, asin: 'B0BP88MYM4', search: 'Corsair+RM1200x+Shift+1200W+80+Plus+Gold+ATX+3.0', watt: 1200, rating: '80+ Gold', modular: 'Full', tier: 'high-end' },
    { id: 'psu-3', name: 'Seasonic Vertex PX-1200', brand: 'Seasonic', price: 1283, asin: 'B0C571DW23', search: 'Seasonic+Vertex+PX-1200+1200W+80+Platinum+ATX+3.0', watt: 1200, rating: '80+ Platinum', modular: 'Full', tier: 'high-end' },
    { id: 'psu-10', name: 'Corsair HX1200i ATX 3.1', brand: 'Corsair', price: 1480, asin: 'B0F3JD7M8M', search: 'Corsair+HX1200i+1200W+ATX+3.1+Platinum', watt: 1200, rating: '80+ Platinum', modular: 'Full', tier: 'high-end' },
    // 850W-1000W
    { id: 'psu-4', name: 'Corsair RM1000x', brand: 'Corsair', price: 699, asin: 'B0D9C1HG19', search: 'Corsair+RM1000x+1000W+80+Plus+Gold+Fully+Modular', watt: 1000, rating: '80+ Gold', modular: 'Full', tier: 'high-end' },
    { id: 'psu-9', name: 'be quiet! Dark Power 13 1000W', brand: 'be quiet!', price: 999, asin: 'B0BV6CWS2Z', search: 'be+quiet+Dark+Power+13+1000W+80+Plus+Titanium', watt: 1000, rating: '80+ Titanium', modular: 'Full', tier: 'enthusiast' },
    { id: 'psu-5', name: 'Corsair RM850x', brand: 'Corsair', price: 549, asin: 'B08R5JPTMZ', search: 'Corsair+RM850x+850W+80+Plus+Gold+Fully+Modular', watt: 850, rating: '80+ Gold', modular: 'Full', tier: 'mid-range' },
    { id: 'psu-6', name: 'Seasonic Focus GX-850', brand: 'Seasonic', price: 479, asin: 'B073H3ZZQZ', search: 'Seasonic+Focus+GX-850+850W+80+Plus+Gold+Full+Modular', watt: 850, rating: '80+ Gold', modular: 'Full', tier: 'mid-range' },
    // 700W-750W
  ...
  cooler: [
    ...
    { id: 'cool-3', name: 'Corsair iCUE LINK H150i RGB', brand: 'Corsair', price: 741, asin: 'B0C6PWQ6L3', search: 'Corsair+iCUE+LINK+H150i+RGB+360mm+AIO', type: 'AIO 360mm', tdpMax: 350, tier: 'high-end' },
    { id: 'cool-7', name: 'NZXT Kraken X73 RGB 360mm', brand: 'NZXT', price: 699, asin: 'B082DYKB1F', search: 'NZXT+Kraken+X73+RGB+360mm+AIO+CPU+Liquid+Cooler', type: 'AIO 360mm', tdpMax: 300, tier: 'high-end' },
    { id: 'cool-8', name: 'Corsair iCUE H150i Elite 360mm', brand: 'Corsair', price: 599, asin: 'B08G1Q3GZR', search: 'Corsair+iCUE+H150i+Elite+Capellix+360mm+AIO', type: 'AIO 360mm', tdpMax: 350, tier: 'high-end' },
    { id: 'cool-2', name: 'DeepCool LS720 SE', brand: 'DeepCool', price: 239, asin: 'B0BLYS73TK', search: 'DeepCool+LS720+SE+360mm+AIO+ARGB', type: 'AIO 360mm', tdpMax: 300, tier: 'mid-range' },
    // AIO 240mm
    { id: 'cool-9', name: 'Arctic Liquid Freezer II 240', brand: 'Arctic', price: 349, asin: 'B07WSDLRVP', search: 'Arctic+Liquid+Freezer+II+240mm+AIO+CPU+Cooler', type: 'AIO 240mm', tdpMax: 200, tier: 'mid-range' },
    // Air Tower
    { id: 'cool-4', name: 'Noctua NH-D15 chromax.Black', brand: 'Noctua', price: 349, asin: 'B07Y87YHRH', search: 'Noctua+NH-D15+chromax.Black+Dual+Tower+CPU+Cooler', type: 'Air Tower', tdpMax: 250, tier: 'high-end' },
  ...
  case: [
    ...
    { id: 'case-3', name: 'Fractal Design North', brand: 'Fractal', price: 687, asin: 'B09V878FXQ', search: 'Fractal+Design+North+Black+Mesh+Mid+Tower', formFactor: 'Mid Tower', maxGPU: 355, tier: 'high-end' },
    { id: 'case-4', name: 'Lian Li Lancool III', brand: 'Lian Li', price: 619, asin: 'B0B7NSQS5Q', search: 'Lian+Li+Lancool+III+White+ATX+Mid+Tower', formFactor: 'Mid Tower', maxGPU: 420, tier: 'mid-range' },
    { id: 'case-5', name: 'NZXT H7 Flow', brand: 'NZXT', price: 449, asin: 'B0B17JZCLB', search: 'NZXT+H7+Flow+ATX+Mid+Tower+White', formFactor: 'Mid Tower', maxGPU: 400, tier: 'mid-range' },
    { id: 'case-6', name: 'Corsair 4000D Airflow', brand: 'Corsair', price: 349, asin: 'B08C7BGV3D', search: 'Corsair+4000D+Airflow+Tempered+Glass+Mid+Tower+Black', formFactor: 'Mid Tower', maxGPU: 360, tier: 'mid-range' },
    { id: 'case-7', name: 'Fractal Design Meshify 2', brand: 'Fractal', price: 499, asin: 'B0822Y6H34', search: 'Fractal+Design+Meshify+2+Black+ATX+Mid+Tower', formFactor: 'Mid Tower', maxGPU: 467, tier: 'high-end' },
