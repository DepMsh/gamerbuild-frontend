...
export const COMPONENTS = {
  ...
  cpu: [
    ...
    { id: 'cpu-7', name: 'Intel Core Ultra 5 245K', brand: 'Intel', price: 939, asin: 'B0DFK2P311', image_url: null, score: 68, socket: 'LGA1851', cores: 14, threads: 14, baseClock: 4.2, boostClock: 5.2, tdp: 125, tier: 'mid-range' },
    // AMD Ryzen 7000 (AM5)
    { id: 'cpu-8', name: 'AMD Ryzen 7 7800X3D', brand: 'AMD', price: 1349, asin: 'B0BTZB7F88', image_url: null, score: 85, socket: 'AM5', cores: 8, threads: 16, baseClock: 4.2, boostClock: 5.0, tdp: 120, tier: 'high-end' },
    { id: 'cpu-9', name: 'AMD Ryzen 5 7600X', brand: 'AMD', price: 699, asin: 'B0BBJMS1TN', image_url: null, score: 72, socket: 'AM5', cores: 6, threads: 12, baseClock: 4.7, boostClock: 5.3, tdp: 105, tier: 'mid-range' },
    { id: 'cpu-12', name: 'AMD Ryzen 9 7950X', brand: 'AMD', price: 1899, asin: 'B0BBHHT8LY', image_url: null, score: 88, socket: 'AM5', cores: 16, threads: 32, baseClock: 4.5, boostClock: 5.7, tdp: 170, tier: 'enthusiast' },
    // Intel 14th/13th Gen (LGA1700)
    { id: 'cpu-10', name: 'Intel Core i7-14700K', brand: 'Intel', price: 1449, asin: 'B0CGJ41C9W', image_url: null, score: 80, socket: 'LGA1700', cores: 20, threads: 28, baseClock: 3.4, boostClock: 5.6, tdp: 125, tier: 'high-end' },
    { id: 'cpu-11', name: 'Intel Core i5-14600K', brand: 'Intel', price: 999, asin: 'B0CGJ9STNF', image_url: null, score: 73, socket: 'LGA1700', cores: 14, threads: 20, baseClock: 3.5, boostClock: 5.3, tdp: 125, tier: 'mid-range' },
    { id: 'cpu-13', name: 'Intel Core i9-14900K', brand: 'Intel', price: 2249, asin: 'B0CGJDKLB8', image_url: null, score: 83, socket: 'LGA1700', cores: 24, threads: 32, baseClock: 3.2, boostClock: 6.0, tdp: 253, tier: 'enthusiast' },
    { id: 'cpu-15', name: 'Intel Core i3-14100F', brand: 'Intel', price: 349, asin: 'B0CQ1MN1Y2', image_url: null, score: 42, socket: 'LGA1700', cores: 4, threads: 8, baseClock: 3.5, boostClock: 4.7, tdp: 58, tier: 'budget' },
    ...
    // AMD Ryzen 5000 (AM4)
    { id: 'cpu-14', name: 'AMD Ryzen 5 5600X', brand: 'AMD', price: 449, asin: 'B08166SLDF', image_url: null, score: 55, socket: 'AM4', cores: 6, threads: 12, baseClock: 3.7, boostClock: 4.6, tdp: 65, tier: 'budget' },
    { id: 'cpu-16', name: 'AMD Ryzen 7 5800X3D', brand: 'AMD', price: 849, asin: 'B09VCJ2GHJ', image_url: null, score: 70, socket: 'AM4', cores: 8, threads: 16, baseClock: 3.4, boostClock: 4.5, tdp: 105, tier: 'mid-range' },
  ],

  // ═══════ GPUs — 26 total ═══════
  gpu: [
    // NVIDIA RTX 50 Series (Blackwell)
    { id: 'gpu-1', name: 'NVIDIA RTX 5090', brand: 'NVIDIA', price: 14999, asin: 'B0DYDY8KSC', search: 'NVIDIA+GeForce+RTX+5090+Founders+Edition+32GB', image_url: null, score: 100, vram: 32, tdp: 575, tier: 'enthusiast' },
    ...
    { id: 'gpu-9', name: 'NVIDIA RTX 4090', brand: 'NVIDIA', price: 7299, asin: 'B0BG94PS2F', search: 'MSI+GeForce+RTX+4090+Gaming+X+Trio+24G', image_url: null, score: 88, vram: 24, tdp: 450, tier: 'enthusiast' },
    { id: 'gpu-10', name: 'NVIDIA RTX 4080 Super', brand: 'NVIDIA', price: 4199, asin: 'B0CSJYJRKD', search: 'Gigabyte+GeForce+RTX+4080+Super+Gaming+OC+16G', image_url: null, score: 73, vram: 16, tdp: 320, tier: 'high-end' },
    ...
    { id: 'gpu-12', name: 'NVIDIA RTX 4070 Super', brand: 'NVIDIA', price: 2399, asin: 'B0CT8LQZ47', search: 'Nvidia+GeForce+RTX+4070+Super+Founders+Edition+12GB', image_url: null, score: 60, vram: 12, tdp: 220, tier: 'mid-range' },
    { id: 'gpu-13', name: 'NVIDIA RTX 4060 Ti', brand: 'NVIDIA', price: 1599, asin: 'B0C5B4XNWR', search: 'MSI+GeForce+RTX+4060+Ti+Ventus+2X+Black+8G+OC', image_url: null, score: 48, vram: 8, tdp: 160, tier: 'mid-range' },
    ...
    { id: 'gpu-15', name: 'AMD RX 7900 XTX', brand: 'AMD', price: 3499, asin: 'B0BMWG9N16', search: 'PowerColor+AMD+Radeon+RX+7900+XTX+24GB', image_url: null, score: 70, vram: 24, tdp: 355, tier: 'high-end' },
    { id: 'gpu-16', name: 'AMD RX 7800 XT', brand: 'AMD', price: 1799, asin: 'B0CGRMJF6C', search: 'Gigabyte+Radeon+RX+7800+XT+Gaming+OC+16G', image_url: null, score: 55, vram: 16, tdp: 263, tier: 'mid-range' },
    { id: 'gpu-17', name: 'AMD RX 7600', brand: 'AMD', price: 999, asin: 'B0C488N4BF', search: 'PowerColor+Fighter+AMD+Radeon+RX+7600+8GB', image_url: null, score: 38, vram: 8, tdp: 165, tier: 'budget' },
    // NVIDIA RTX 30 Series (Ampere)
    { id: 'gpu-21', name: 'NVIDIA RTX 3090 24GB', brand: 'NVIDIA', price: 2799, asin: 'B08HRBW6VB', search: 'NVIDIA+GeForce+RTX+3090+24GB', image_url: null, score: 60, vram: 24, tdp: 350, tier: 'enthusiast' },
    { id: 'gpu-22', name: 'NVIDIA RTX 3080 Ti 12GB', brand: 'NVIDIA', price: 2199, asin: 'B096L83WV8', search: 'NVIDIA+GeForce+RTX+3080+Ti+12GB', image_url: null, score: 58, vram: 12, tdp: 350, tier: 'high-end' },
    { id: 'gpu-23', name: 'NVIDIA RTX 3080 10GB', brand: 'NVIDIA', price: 1999, asin: 'B08HR7SV3M', search: 'NVIDIA+GeForce+RTX+3080+10GB', image_url: null, score: 55, vram: 10, tdp: 320, tier: 'high-end' },
    { id: 'gpu-24', name: 'NVIDIA RTX 3070 Ti 8GB', brand: 'NVIDIA', price: 1499, asin: 'B097PZT7J3', search: 'NVIDIA+GeForce+RTX+3070+Ti+8GB', image_url: null, score: 50, vram: 8, tdp: 290, tier: 'mid-range' },
    { id: 'gpu-25', name: 'NVIDIA RTX 3070 8GB', brand: 'NVIDIA', price: 1399, asin: 'B08HBJB7YD', search: 'NVIDIA+GeForce+RTX+3070+8GB', image_url: null, score: 48, vram: 8, tdp: 220, tier: 'mid-range' },
    { id: 'gpu-26', name: 'NVIDIA RTX 3060 Ti 8GB', brand: 'NVIDIA', price: 1099, asin: 'B08PW559LL', search: 'NVIDIA+GeForce+RTX+3060+Ti+8GB', image_url: null, score: 42, vram: 8, tdp: 200, tier: 'budget' },
    { id: 'gpu-27', name: 'NVIDIA RTX 3060 12GB', brand: 'NVIDIA', price: 999, asin: 'B08WPRMVWB', search: 'NVIDIA+GeForce+RTX+3060+12GB', image_url: null, score: 35, vram: 12, tdp: 170, tier: 'budget' },
    { id: 'gpu-28', name: 'NVIDIA GTX 1660 Super 6GB', brand: 'NVIDIA', price: 599, asin: 'B084NW6VFC', search: 'NVIDIA+GeForce+GTX+1660+Super+6GB', image_url: null, score: 20, vram: 6, tdp: 125, tier: 'budget' },
  ],
